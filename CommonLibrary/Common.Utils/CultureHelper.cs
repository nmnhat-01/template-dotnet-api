...
public class CultureHelper
{
    ...
    private static readonly List<string> _cultures = new List<string> { "en", "vi" };
    ...
    public static string GetImplementedCulture(string name)
    {
        ...
        if (string.IsNullOrEmpty(name))
            name = Thread.CurrentThread.CurrentCulture.TwoLetterISOLanguageName; // set default culture
    ...
    public static string GetCultures(int index)
    {
        return _cultures[index]; // return Default culture
    }
}